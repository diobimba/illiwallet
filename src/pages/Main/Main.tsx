      ...
      <main className="relative grid gap-28">
        <div className="row">
          <div className="container mx-auto">
            <div className="grid gap-4 p-5 sm:grid-cols-2 relative">
        ...
        <div className="row">
          <div className="container mx-auto">
            <div className="py-5 grid gap-4 p-5 sm:grid-cols-2 relative">
              <img src={coinDisassembled} loading="lazy" className="relative w-80 mx-auto order-1" alt="Coin" />
              <div className="mr-auto max-w-lg">
        ...
        <div className="row">
          <div className="container mx-auto">
            <div className="py-5 relative text-center">
              ...
              <ul className="grid grid-cols-2 px-4 sm:grid-cols-3 text-white gap-4 sm:gap-28">
